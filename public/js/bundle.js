...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiam9obmRvZXN2a2kiLCJhIjoiY2xqb2wxNmpvMWFzYzNucjcyYXY0bXFnZiJ9.WxvhfciTzIjyKIhCP8P8GQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/johndoesvki/cljomqdjk00o701pqa880fkut',
    scrollZoom: false
...
var stripe = Stripe('pk_test_51NUSxLBqpdfLIKz6To77MfcjmRvOC0ggFvQwIGbRRFoIuL57Guz8zjTNizxWwiBGcRCmMWMooqlFFxMPvnYUeBhU00fckHpZ2M');
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var password, passwordCurrent, passwordConfirm, name;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
...
console.log('yoooooooooooooooooooooooooooooooooooooooooooo');
console.log(bookBtn);
if (bookBtn) {
